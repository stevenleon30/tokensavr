...
export const PLATFORM_PRICING: Record<string, PlatformPricing> = {
  lovable: {
    ...
    models: ["claude-sonnet-4.6", "gemini-3.7-flash"],
  ...
  chatgpt: {
    ...
    freeTier: "Free tier with rate-limited GPT-5.4 access",
  ...
  gemini: {
    ...
    notes: "Flash-class models are the cheapest capable option per token in the catalog.",
    lastVerified: PRICING_VERSION,
    source: "https://ai.google.dev/pricing",
  },
};
