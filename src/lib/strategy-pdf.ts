...
export function downloadStrategyPdf(strategy: StrategyForPdf, filename = "tokensavr-strategy.pdf") {
  ...
  doc.text("TokenSavr", logoX + logoSize + 12, logoY + 12);
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text("Generated by TokenSavr", PAGE_MARGIN, pageHeight - 20);
    doc.text(
      `Page ${i} of ${pageCount}`,
